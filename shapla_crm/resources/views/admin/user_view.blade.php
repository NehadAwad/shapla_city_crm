       ...
       <section class="content">
           <div class="container-fluid">
               <table cellpadding="0" cellspacing="0" border="0" align="center" width="1000" style="border: 0px;" >
                   <tr class="br_none">
                       <td style="border:0px;">
                           <a href="/admin/member/{{$user->id}}/pdf" style="padding: 12px 25px; background: #993300; font-size:18px;font-width:bold;text-decoration:none; color:#fff; border-radius:10px;margin-top: 10px;">Download PDF</a>
                           <a href="#" onclick="window.print()" style="padding: 12px 25px; background: #009999; font-size:18px;font-width:bold;text-decoration:none; color:#fff; border-radius:10px;margin-top: 10px;">Print</a>
                       </td>
                   </tr>
               </table>
                       ...
                       <td style="border: 0px !important; padding: 0 !important;">
                           <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                               ...
                               <tr>
                                   ...
                                   <td style="border-left:1px solid #C9CACC;">{{$user->address}}</td>
                               </tr>
                               <tr>
                               ...
                               <tr>
                                   ...
                                   <td style="border_left:1px solid #C9CACC;">{{$user->profession}}</td>
                               </tr>
                               <tr>
                               ...
                               <tr>
                                   ...
                                   <td style="border-left:1px solid #C9CACC;">{{$user->relation_with_member}}</td>
                               </tr>
                               <tr>
                                   <td>Building No:</td>
                               ...
                               <tr>
                                   <td>Total Amount:</td>
                                   <td style="border-left:1px solid #C9CACC;">{{$user->total_amount}}</td>
                               </tr>
                               <tr>
                                   <td>No of Installment:</td>
                                   <td style="border-left:1px solid #C9CACC;">{{$user->no_of_installment}}</td>
                               </tr>

                               <tr>
                                   <td>Installment Start Form:</td>
                                   <td style="border-left:1px solid #C9CACC;">{{$user->installment_start_from}}</td>
                               </tr>
                               <tr>
                                   <td>Description:</td>
                               ...
                               <tr class="br_none">
                                   ...
                                   <td style="border: 0px;padding: 0px;" class="pb_0 pl_0">
                                       <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                           ...
                                           <tr>
                                               <td style="border-left:0px;">Current  Due</td>
                   ...
                   <tr class="br_none">
                       <td colspan="2" style="padding: 0px; border:none;">
                           <table cellpadding="0" cellspacing="0" border="0" align="center" width="1000" style=" margin-top: 30px; margin-bottom: 10px;">
                               <tr>
                                   <th colspan="2"><h2 style="text-align: center; padding: 20px 0;" class="btn-success">Installment History</h2></th>
                               </tr>
