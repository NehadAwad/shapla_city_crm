<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a style="text-decoration: none;" href="{{route('dashboard')}}" class="brand-link">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a style="text-decoration: none;" href="{{route('dashboard')}}" class="d-block">{{ Auth::user()->member_name }}</a>
            </div>
        </div>
